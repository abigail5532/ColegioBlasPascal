        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4 custom-scroll" style="margin-bottom: 15px;">
                ...
                <div class="card-body">
                    ...
                    d.apellidos AS apellidos_docente, d.nombres AS nombres_docente, n.nombre AS nivel, g.nombre AS grado
                    FROM anuncios a
                    ...
                    var content = `
                        ...
                        <div class="modal-footer">
                            <form action="deleteAnuncios.php?idanun=${anuncio.idanun}" method="post" class="eliminarconfirmar d-inline">
                                <button class="btn btn-danger" type="submit"><i class='fas fa-trash-alt'></i>  Eliminar anuncio</button>
                            </form>
                        </div>
                    `;
